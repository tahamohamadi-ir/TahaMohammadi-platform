# PU-15-articles — Implement complete F06 index/detail with CMS story and original CA-13 visual acceptance; remove placeholders, retain actual published facts.

Owner: **PUBLIC** (`D:/Project/tahamohammadi-platform/Front-End/public-site`). Status: **NOT_STARTED**.

Dependencies: PU-13-routes, PU-13-story. Family: F06.
...
- `src/lib/writing-content.ts`
- `src/components/writing/WritingPageContent.astro`
- `src/components/writing/WritingDetailContent.astro`
- `src/styles/product-writing.css` — NEW/PROPOSED
- `src/pages/fa/blog/index.astro`
- `src/pages/fa/blog/[slug].astro`
- `src/pages/en/blog/index.astro`
- `src/pages/en/blog/[slug].astro`
- `src/components/page-family/PageFamilyThemeExploreShell.astro`
- `src/styles/pf03-alignment.css` — NEW/PROPOSED
- `src/components/writing/public-211.behavior.test.ts`
- `src/components/writing/product-family.test.ts` — NEW/PROPOSED
- `docs/quality/product-v2/PU-15-articles-HANDOFF.md` — NEW/PROPOSED
...
Visual criteria source (read-only): packets/CA-13.md. Transfer its Done when / visual checks; do not execute its retired allowlist.

## Acceptance and verification

- npm.cmd test -- src/components/writing/product-family.test.ts
...
Return exact base/result commits (or explicitly uncommitted), changed paths, tests with results, schema hash/impact, screenshots where UI changed, dirty status and remaining risks in `docs/quality/product-v2/PU-15-articles-HANDOFF.md`.

Stop: **PU-15-articles_HANDOFF_READY**. Do not begin another packet, edit another repository, merge, push, deploy or mark owner acceptance.
