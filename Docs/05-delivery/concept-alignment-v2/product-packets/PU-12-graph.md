...
- `src/pages/GraphEditPage.tsx`
- `src/pages/GraphPage.tsx`
- `src/lib/api/graph.ts`
- `src/pages/GraphEditPage.test.tsx`
- `docs/quality/product-v2/PU-12-graph-HANDOFF.md` — NEW/PROPOSED
...
- npm.cmd test -- src/pages/GraphEditPage.test.tsx
...
Return exact base/result commits (or explicitly uncommitted), changed paths, tests with results, schema hash/impact, screenshots where UI changed, dirty status and remaining risks in `docs/quality/product-v2/PU-12-graph-HANDOFF.md`.

Stop: **PU-12-graph_HANDOFF_READY**. Do not begin another packet, edit another repository, merge, push, deploy or mark owner acceptance.
