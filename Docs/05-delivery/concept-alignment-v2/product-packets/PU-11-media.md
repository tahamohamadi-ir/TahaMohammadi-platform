...
- `src/lib/api/hooks/useMedia.ts`
- `src/pages/MediaPage.test.tsx`
- `docs/quality/product-v2/PU-11-media-HANDOFF.md` — NEW/PROPOSED
...
- npm.cmd test -- src/pages/MediaPage.test.tsx
...
Return exact base/result commits (or explicitly uncommitted), changed paths, tests with results, schema hash/impact, screenshots where UI changed, dirty status and remaining risks in `docs/quality/product-v2/PU-11-media-HANDOFF.md`.

Stop: **PU-11-media_HANDOFF_READY**. Do not begin another packet, edit another repository, merge, push, deploy or mark owner acceptance.
