# PU-16-resources — Build canonical resources pages from accepted projections, full body and real file/member links; no duplicate content records.

Owner: **PUBLIC** (`D:/Project/tahamohammadi-platform/Front-End/public-site`). Status: **NOT_STARTED**.

Dependencies: PU-13-routes, PU-13-story. Family: F11.
...
- `src/lib/resources-content.ts` — NEW/PROPOSED
- `src/components/resources/CollectionPage.astro` — NEW/PROPOSED
- `src/components/resources/DetailPage.astro` — NEW/PROPOSED
- `src/styles/product-resources.css` — NEW/PROPOSED
- `src/pages/fa/resources/index.astro` — NEW/PROPOSED
- `src/pages/fa/resources/[slug].astro` — NEW/PROPOSED
- `src/pages/en/resources/index.astro` — NEW/PROPOSED
- `src/pages/en/resources/[slug].astro` — NEW/PROPOSED
- `src/lib/resources-content.test.ts` — NEW/PROPOSED
- `docs/quality/product-v2/PU-16-resources-HANDOFF.md` — NEW/PROPOSED
...
- npm.cmd test -- src/lib/resources-content.test.ts
...
Return exact base/result commits (or explicitly uncommitted), changed paths, tests with results, schema hash/impact, screenshots where UI changed, dirty status and remaining risks in `docs/quality/product-v2/PU-16-resources-HANDOFF.md`.

Stop: **PU-16-resources_HANDOFF_READY**. Do not begin another packet, edit another repository, merge, push, deploy or mark owner acceptance.
