# PU-16-series — Build canonical series pages from accepted projections, full body and real file/member links; no duplicate content records.
...
- `src/lib/series-content.ts` — NEW/PROPOSED
- `src/components/series/CollectionPage.astro` — NEW/PROPOSED
- `src/components/series/DetailPage.astro` — NEW/PROPOSED
- `src/styles/product-series.css` — NEW/PROPOSED
- `src/pages/fa/blog/series/[slug].astro` — NEW/PROPOSED
- `src/pages/en/blog/series/[slug].astro` — NEW/PROPOSED
- `src/lib/series-content.test.ts` — NEW/PROPOSED
- `docs/quality/product-v2/PU-16-series-HANDOFF.md` — NEW/PROPOSED
...
- npm.cmd test -- src/lib/series-content.test.ts
...
Return exact base/result commits (or explicitly uncommitted), changed paths, tests with results, schema hash/impact, screenshots where UI changed, dirty status and remaining risks in `docs/quality/product-v2/PU-16-series-HANDOFF.md`.

Stop: **PU-16-series_HANDOFF_READY**. Do not begin another packet, edit another repository, merge, push, deploy or mark owner acceptance.
