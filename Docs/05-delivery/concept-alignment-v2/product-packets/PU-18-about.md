# PU-18-about — Complete about content and original CA visual scope; use owner profile and real versioned resource links; verify print when CV.

Owner: **PUBLIC** (`D:/Project/tahamohammadi-platform/Front-End/public-site`). Status: **IMPLEMENTED_UNREVIEWED**.

Dependencies: PU-13-routes, PU-13-story. Family: F13.
...
- `src/lib/about-profile.ts`
- `src/pages/fa/about/index.astro`
- `src/pages/en/about/index.astro`
- `src/components/about/product-about.test.ts` — NEW/PROPOSED
- `docs/quality/product-v2/PU-18-about-HANDOFF.md` — NEW/PROPOSED
...
- npm.cmd test -- src/components/about/product-about.test.ts
...
Return exact base/result commits (or explicitly uncommitted), changed paths, tests with results, schema hash/impact, screenshots where UI changed, dirty status and remaining risks in `docs/quality/product-v2/PU-18-about-HANDOFF.md`.

Stop: **PU-18-about_HANDOFF_READY**. Do not begin another packet, edit another repository, merge, push, deploy or mark owner acceptance.
