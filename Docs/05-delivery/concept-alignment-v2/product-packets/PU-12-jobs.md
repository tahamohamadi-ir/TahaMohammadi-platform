...
- `src/pages/PublicationJobsPage.tsx` — NEW/PROPOSED
- `src/pages/DashboardPage.tsx`
- `src/app/router.tsx`
- `src/components/Nav.tsx`
- `src/pages/PublicationJobsPage.test.tsx` — NEW/PROPOSED
- `docs/quality/product-v2/PU-12-jobs-HANDOFF.md` — NEW/PROPOSED
...
- npm.cmd test -- src/pages/PublicationJobsPage.test.tsx
...
Return exact base/result commits (or explicitly uncommitted), changed paths, tests with results, schema hash/impact, screenshots where UI changed, dirty status and remaining risks in `docs/quality/product-v2/PU-12-jobs-HANDOFF.md`.

Stop: **PU-12-jobs_HANDOFF_READY**. Do not begin another packet, edit another repository, merge, push, deploy or mark owner acceptance.
