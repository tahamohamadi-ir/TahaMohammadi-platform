...
- `src/lib/collections-content.ts` — NEW/PROPOSED
- `src/components/collections/CollectionPage.astro` — NEW/PROPOSED
- `src/components/collections/DetailPage.astro` — NEW/PROPOSED
- `src/styles/product-collections.css` — NEW/PROPOSED
- `src/pages/fa/collections/index.astro` — NEW/PROPOSED
- `src/pages/fa/collections/[slug].astro` — NEW/PROPOSED
- `src/pages/en/collections/index.astro` — NEW/PROPOSED
- `src/pages/en/collections/[slug].astro` — NEW/PROPOSED
- `src/lib/collections-content.test.ts` — NEW/PROPOSED
- `docs/quality/product-v2/PU-16-collections-HANDOFF.md` — NEW/PROPOSED
...
- npm.cmd test -- src/lib/collections-content.test.ts
...
Return exact base/result commits (or explicitly uncommitted), changed paths, tests with results, schema hash/impact, screenshots where UI changed, dirty status and remaining risks in `docs/quality/product-v2/PU-16-collections-HANDOFF.md`.

Stop: **PU-16-collections_HANDOFF_READY**. Do not begin another packet, edit another repository, merge, push, deploy or mark owner acceptance.
