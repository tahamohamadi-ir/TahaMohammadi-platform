...
- `src/components/editor/profile-fields.tsx` — NEW/PROPOSED
- `src/components/editor/profile-fields.test.tsx` — NEW/PROPOSED
- `docs/quality/product-v2/PU-08-profile-HANDOFF.md` — NEW/PROPOSED
...
- npm.cmd test -- src/components/editor/profile-fields.test.tsx
...
Return exact base/result commits (or explicitly uncommitted), changed paths, tests with results, schema hash/impact, screenshots where UI changed, dirty status and remaining risks in `docs/quality/product-v2/PU-08-profile-HANDOFF.md`.

Stop: **PU-08-profile_HANDOFF_READY**. Do not begin another packet, edit another repository, merge, push, deploy or mark owner acceptance.
