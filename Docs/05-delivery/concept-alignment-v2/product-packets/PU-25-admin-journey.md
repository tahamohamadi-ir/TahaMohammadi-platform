...
- `tests/e2e/product-journey.spec.ts` — NEW/PROPOSED
- `src/pages/product-journey.test.tsx` — NEW/PROPOSED
- `docs/quality/product-v2/PU-25-admin-journey-HANDOFF.md` — NEW/PROPOSED
...
- npm.cmd test -- src/pages/product-journey.test.tsx
