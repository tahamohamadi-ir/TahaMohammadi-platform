...
- `src/components/contact/ContactPageContent.astro`
- `src/components/page-family/PageFamilyContactHeroShell.astro`
- `src/components/page-family/PageFamilyContactSidebarShell.astro`
- `src/styles/pf08-alignment.css` — NEW/PROPOSED
- `src/components/contact/public-230.behavior.test.ts`
- `src/lib/contact-content.ts`
- `src/pages/fa/contact/index.astro`
- `src/pages/en/contact/index.astro`
- `src/components/contact/product-contact.test.ts` — NEW/PROPOSED
- `docs/quality/product-v2/PU-18-contact-HANDOFF.md` — NEW/PROPOSED
...
Visual criteria source (read-only): packets/CA-16.md. Transfer its Done when / visual checks; do not execute its retired allowlist.

## Acceptance and verification

- npm.cmd test -- src/components/contact/product-contact.test.ts
...
Return exact base/result commits (or explicitly uncommitted), changed paths, tests with results, schema hash/impact, screenshots where UI changed, dirty status and remaining risks in `docs/quality/product-v2/PU-18-contact-HANDOFF.md`.

Stop: **PU-18-contact_HANDOFF_READY**. Do not begin another packet, edit another repository, merge, push, deploy or mark owner acceptance.
