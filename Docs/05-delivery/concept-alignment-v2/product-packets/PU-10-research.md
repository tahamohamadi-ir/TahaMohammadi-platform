...
- `src/components/editor/research-fields.tsx` — NEW/PROPOSED
- `src/components/editor/research-fields.test.tsx` — NEW/PROPOSED
- `docs/quality/product-v2/PU-10-research-HANDOFF.md` — NEW/PROPOSED
...
- npm.cmd test -- src/components/editor/research-fields.test.tsx
...
Return exact base/result commits (or explicitly uncommitted), changed paths, tests with results, schema hash/impact, screenshots where UI changed, dirty status and remaining risks in `docs/quality/product-v2/PU-10-research-HANDOFF.md`.

Stop: **PU-10-research_HANDOFF_READY**. Do not begin another packet, edit another repository, merge, push, deploy or mark owner acceptance.
