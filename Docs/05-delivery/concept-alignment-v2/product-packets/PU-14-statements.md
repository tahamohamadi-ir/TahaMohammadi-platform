...
- `src/components/research/ResearchStatementDetailContent.astro` — NEW/PROPOSED
- `src/pages/fa/research/statements/[slug].astro` — NEW/PROPOSED
- `src/pages/en/research/statements/[slug].astro` — NEW/PROPOSED
- `src/components/research/product-statements.test.ts` — NEW/PROPOSED
- `docs/quality/product-v2/PU-14-statements-HANDOFF.md` — NEW/PROPOSED
...
- npm.cmd test -- src/components/research/product-statements.test.ts
...
Return exact base/result commits (or explicitly uncommitted), changed paths, tests with results, schema hash/impact, screenshots where UI changed, dirty status and remaining risks in `docs/quality/product-v2/PU-14-statements-HANDOFF.md`.

Stop: **PU-14-statements_HANDOFF_READY**. Do not begin another packet, edit another repository, merge, push, deploy or mark owner acceptance.
