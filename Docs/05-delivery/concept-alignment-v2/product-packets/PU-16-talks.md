# PU-16-talks — Build canonical talks pages from accepted projections, full body and real file/member links; no duplicate content records.

Owner: **PUBLIC** (`D:/Project/tahamohammadi-platform/Front-End/public-site`). Status: **IMPLEMENTED_UNREVIEWED**.

Dependencies: PU-13-routes, PU-13-story. Family: F10.
...
- `src/lib/talks-content.ts` — NEW/PROPOSED
- `src/components/talks/CollectionPage.astro` — NEW/PROPOSED
- `src/components/talks/DetailPage.astro` — NEW/PROPOSED
- `src/styles/product-talks.css` — NEW/PROPOSED
- `src/pages/fa/talks/index.astro` — NEW/PROPOSED
- `src/pages/fa/talks/[slug].astro` — NEW/PROPOSED
- `src/pages/en/talks/index.astro` — NEW/PROPOSED
- `src/pages/en/talks/[slug].astro` — NEW/PROPOSED
- `src/lib/talks-content.test.ts` — NEW/PROPOSED
- `docs/quality/product-v2/PU-16-talks-HANDOFF.md` — NEW/PROPOSED
...
- npm.cmd test -- src/lib/talks-content.test.ts
...
Return exact base/result commits (or explicitly uncommitted), changed paths, tests with results, schema hash/impact, screenshots where UI changed, dirty status and remaining risks in `docs/quality/product-v2/PU-16-talks-HANDOFF.md`.

Stop: **PU-16-talks_HANDOFF_READY**. Do not begin another packet, edit another repository, merge, push, deploy or mark owner acceptance.
