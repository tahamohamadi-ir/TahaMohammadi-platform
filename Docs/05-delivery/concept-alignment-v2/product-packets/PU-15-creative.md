...
- `src/lib/creative-content.ts`
- `src/components/creative/CreativePageContent.astro`
- `src/components/creative/CreativeDetailContent.astro`
- `src/styles/product-creative.css` — NEW/PROPOSED
- `src/pages/fa/gallery/index.astro`
- `src/pages/fa/gallery/[slug].astro`
...
- `src/styles/pf01-pf02-alignment.css` — NEW/PROPOSED
- `src/components/creative/public-221.behavior.test.ts`
- `src/components/creative/product-family.test.ts` — NEW/PROPOSED
- `docs/quality/product-v2/PU-15-creative-HANDOFF.md` — NEW/PROPOSED
...
Visual criteria source (read-only): packets/CA-15.md. Transfer its Done when / visual checks; do not execute its retired allowlist.

## Acceptance and verification

- npm.cmd test -- src/components/creative/product-family.test.ts
...
Return exact base/result commits (or explicitly uncommitted), changed paths, tests with results, schema hash/impact, screenshots where UI changed, dirty status and remaining risks in `docs/quality/product-v2/PU-15-creative-HANDOFF.md`.

Stop: **PU-15-creative_HANDOFF_READY**. Do not begin another packet, edit another repository, merge, push, deploy or mark owner acceptance.
