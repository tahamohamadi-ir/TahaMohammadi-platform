...
- `src/lib/home-published-links.ts`
- `src/lib/routes.test.ts`
- `docs/quality/product-v2/PU-13-routes-HANDOFF.md` — NEW/PROPOSED
...
- npm.cmd test -- src/lib/routes.test.ts
...
Return exact base/result commits (or explicitly uncommitted), changed paths, tests with results, schema hash/impact, screenshots where UI changed, dirty status and remaining risks in `docs/quality/product-v2/PU-13-routes-HANDOFF.md`.

Stop: **PU-13-routes_HANDOFF_READY**. Do not begin another packet, edit another repository, merge, push, deploy or mark owner acceptance.
