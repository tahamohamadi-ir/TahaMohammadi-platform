...
| RISK-007 | Local-only checks are mistaken for CI enforcement | Medium | Required CI checks plus implemented workflows | Workflows implemented and green in all three repositories 2026-09-10, including dependency audit and detect-secrets baseline gates; branch protection owner-pending |
